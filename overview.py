...
s3 = """
FastHTML works well right now, but it's still young. We are using it for nearly every part of the FastHTML project itself. For instance, we worked with a design team to create the [fastht.ml home page](https://www.fastht.ml/), which is implemented in FastHTML too---here is the [home page source](https://github.com/AnswerDotAI/home-fasthtml/blob/main/main.py).
